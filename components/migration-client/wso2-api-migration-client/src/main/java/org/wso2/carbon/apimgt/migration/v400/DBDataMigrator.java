package org.wso2.carbon.apimgt.migration.v400;
...
public class DBDataMigrator extends Migrator {
    ...
    private static final Log log = LogFactory.getLog(DBDataMigrator.class);
