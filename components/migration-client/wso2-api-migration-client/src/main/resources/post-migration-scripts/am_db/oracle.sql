...
BEGIN
  ...
  BEGIN
    ...
    INTO con_name
    FROM user_constraints where table_name = 'AM_GW_API_DEPLOYMENTS' and constraint_type = 'R';
...
BEGIN
  ...
  BEGIN
    SELECT constraint_name
    INTO con_name
    FROM user_constraints where table_name = 'AM_GW_API_ARTIFACTS' and constraint_type = 'R';
...
BEGIN
  ...
  BEGIN
    SELECT constraint_name
    INTO con_name
    FROM user_constraints where table_name = 'AM_API_RATINGS' and constraint_type = 'R';
...
BEGIN
  ...
  BEGIN
    SELECT constraint_name
    INTO con_name
    FROM user_constraints where table_name = 'AM_API_COMMENTS' and constraint_type = 'R';
...
BEGIN
  ...
  BEGIN
    SELECT constraint_name
    INTO con_name
    FROM user_constraints where table_name = 'AM_API_LC_EVENT' and constraint_type = 'R';
