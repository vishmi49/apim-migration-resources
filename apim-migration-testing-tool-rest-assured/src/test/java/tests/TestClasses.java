...
import restapi.devportal.DevPortal.KeyManagerCollections;
...
public class TestClasses {
    ...
    public void dataGeneration() throws RestAssuredMigrationException {
        ...
        //Deployments
        Publisher.Deployments pDeployement = new Publisher.Deployments(accessToken, ApimVersions.APIM_3_2);
    ...
    @Test
    public void devPortalTest() throws RestAssuredMigrationException {
        AuthenticationObject authenticationObject = new AuthenticationObject();
        authenticationObject.setUsername("admin");
        authenticationObject.setUserpassword("admin");
        authenticationObject.setEndpoint("https://localhost:9443/client-registration/v0.17/register");
...
//            DevPortal devPortal = new DevPortal();
        ...
        KeyManagerCollections dGraphQlPolicies = new KeyManagerCollections(accessToken, ApimVersions.APIM_3_2);
